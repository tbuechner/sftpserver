...
public class Server implements PasswordAuthenticator, PublickeyAuthenticator {
    ...
    public static final String CONFIG_FILE = "/sftpd.conf";
    ...
    protected void setupCompress() {
        ...
        sshd.setCompressionFactories(Arrays.<NamedFactory<Compression>> asList(new CompressionNone.Factory(), new CompressionZlib.Factory(),
    ...
    static class Config {
        ...
        public static final String PROP_ENABLE_WRITE = "writepermission"; // true
                                                                          // /
                                                                          // false
